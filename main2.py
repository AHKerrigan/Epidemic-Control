...
env = epi_env.Epi_Env(B=0.3, graph=graph, beta_hi=0.177, beta_low=0.071, delta_low=0.20, delta_hi=0.285, action_clusters=10)
...
for i_episode in count(1):
    ...
    if i_episode % args.log_interval == 0:
        f = open("PPO-Watts100-Cluster10.csv", "a")
        ff = open("PPO-Watts100-Cluster10hur.csv", "a")
